...
<div class="b-contents table-area">
    <p class="contents-tit">EG-Platform</p>

    <div class="b-contentsTable b-contents__inner">
        <table class="b-activeTable" id="egPlatformTable">
            <colgroup>
                <col style="width: 7%">
                <col style="width: 13%">
                <col style="width: 12%">
            ...
            <tbody class="main-tableBody" id="egPlatformServerLog">
            <%--<tr class="grey">
        ...
        <div class="list-none dis_n" id="egPlatformListNone">
            <p>리스트가 없습니다.</p>
        </div>
    </div>
</div>