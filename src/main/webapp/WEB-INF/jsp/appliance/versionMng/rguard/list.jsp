...
<section class="l-content-area">
    ...
    <h1 class="main-title trn" data-trn-key="TR_APPLIANCE_TITLE6"><%--R-Guard Version 관리--%></h1>
        ...
        <section class="mt30">
            ...
            <div class="b-tableWrap mt20">
                <table class="b-listTable">
                    ...
                    <tr>
                        <th>WEB</th>
                        <th>SCMA<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                        <th>SCM GUARD<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                        <th>SCM GUARD MTA<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                        <th>SCM SUB<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                        <th>SCM GUARD SMTPC<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                        <th>SECU MANAGER<br><span class="trn" data-trn-key="TR_APPLIANCE_FILE_OPERATION"><%--(파일/운영)--%></span></th>
                    </tr>
                    </thead>
                    <tbody>
                    <%-- LINE :: 최신버전 등록 안된경우 --%>
