    ...
    <div class="l-maxwrap">
        ...
        <form id="saveForm">
                ...
                <div class="b-tableWrap mt10 ofx-h">
                    <table class="b-listTable b-listTable--border">
                                ...
                                <select class="default-input w155" name="partnerIdx" onchange="getPartnerInfo()">
                                    <c:forEach var="partner" items="${partnerList}">
                                        <c:if test="${customer.partnerIdx == null || customer.partnerIdx == 0}">
                                            <c:if test="${partner.name == '기원테크2'}">
                                                <option class="trn" data-trn-key="TR_KIWONTECH2" value="${partner.idx}" selected><%--기원테크2--%></option>
                                            </c:if>
                                            <c:if test="${partner.name != '기원테크2'}">
                                                <option value="${partner.idx}">${partner.name}</option>
                                            </c:if>
                                        </c:if>
                                        <c:if test="${customer.partnerIdx != null && customer.partnerIdx > 0}">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="employCount" class="default-input w200 onlynumber autoComma trn" data-trn-holder="TR_ONLY_NUMBER" value="${customer.employCount}" placeholder="<%--숫자만 입력하세요.--%>" maxlength="9">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <span class="dis_b mb5">
                                    ...
                                    <input type="button" class="btn btn-baseRound" value="주소검색" onclick="openAddrPopup('customer')">
                                </span>
                ...
                <div class="b-tableWrap mt10 ofx-h">
                    <table class="b-listTable b-listTable--border adminInfoTable">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="w120 default-input trn" data-trn-value="TR_COMMON_NAME" name="adminName" placeholder="" value="${customer.adminName}" maxlength="10"><%--이름--%>
                                /
                                <input type="text" class="w120 default-input trn" data-trn-valye="TR_POSITION" name="adminPosition" placeholder="" value="${customer.adminPosition}" maxlength="10"><%--직책--%>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                ...
                                <br/><span class="small-txt dis_b trn" data-trn-key="TR_CLOUD_ADMIN_SUB_EMAIL_DESCRIPTION"><%--(*보조 이메일을 통해 서비스 가입안내를 드릴 예정으로 정확한 내용 기재 부탁드립니다.)--%></span>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <input type="text" class="w155 default-input trn" data-trn-holder="TR_ID_DESCRIPTION" name="adminId" value="${customer.adminId}" placeholder="" maxlength="30"><%--영문, 숫자 조합--%>
                                    </c:otherwise>
                                </c:choose>
                            </td>
                            <%-- LINE :: 장비설치 안된 고객사만 표시 --%>
                            <c:if test="${!customer.equipmentInstallYn}">
                                ...
                                <td>
                                    <input type="password" class="default-input w200 trn" data-trn-key="TR_PW_DESCRIPTION" name="adminPwd" placeholder="" maxlength="30"><%--영문, 숫자, 특수문자 8~16자--%>
                                </td>
                            </c:if>
                        </tr>
                        ...
                        <c:forEach var="subAdmin" items="${subAdminList}" varStatus="status">
                            ...
                            <tr class="subAdminInfo${status.index + 2}">
                                ...
                                <td>
                                    <input type="text" class="w120 default-input subAdminName trn" data-trn-holder="TR_COMMON_NAME" name="sub[${status.index}].adminName" placeholder="" value="${subAdmin.adminName}" maxlength="10"><%--이름--%>
                                    /
                                    <input type="text" class="w120 default-input subAdminPosition trn" data-trn-holder="TR_POSITION" name="sub[${status.index}].adminPosition" placeholder="" value="${subAdmin.adminPosition}" maxlength="10"></td><%--직책--%>
            ...
            <section class="mt30">
                ...
                <div class="b-tableWrap mt20">
                    <table class="b-listTable b-listTable--border">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="pServiceArea">
                                    <input type="text" name="applyAccountCount" class="default-input wp60 onlynumber autoComma trn" data-trn-value="TR_ONLY_NUM" onchange="setConsumerPrice()" value="${customer.applyAccountCount}" placeholder=""><%--숫자만 입력--%>
                                </span>
                            </td>
                        </tr>
                        <tr rowspan="5">
                            <th rowspan="5" id="applyDomainArea"><span class="necessary trn" data-trn-key="TR_CLOUD_APPLY_DOMAIN"><%--신청 도메인--%></span></th>
                            <td colspan="3">
                                <p class="mb10 mt5">
                                    <label class="dis_ib w80">
                                ...
                                @ <input type="text" name="applyMainDomain" class="default-input"
                                         value="${customer != null && !customer.ownDomainYn ? fn:split(customer.applyMainDomain, ".")[0] : customer.applyMainDomain}"
                                         placeholder="ex) ${customer == null || customer.ownDomainYn ? 'example.com' : 'example'}" style="width: 201px;">
                                <span class="ownDomainFalseArea" style="${customer == null || customer.ownDomainYn ? 'display: none;' : ''}">
                                    ${domain != null ? domain : ".secuecloud.com"}
                                    <input type="button" class="btn btn-baseRound trn" data-trn-value="TR_COMMON_OVERLAP_CHECK" value="" onclick="domainDuplicateCheckAjax();"><%--중복검사--%>
                                </span>

                                <input type="button" class="mViewBtn_permit pServiceAndOwnDomainTrueArea" value="+" style="width: 30px;" onclick="addSubDomain()">
                                <input type="button" class="btn btn-baseRound ownDomainTrueArea trn" data-trn-value="TR_COMMON_OVERLAP_CHECK" value="" onclick="domainDuplicateCheckAjax();" style="${!customer.ownDomainYn ? 'display: none;' : ''}"><%--중복확인--%>
                                <span class="pServiceAndOwnDomainTrueArea ml5 trn" dat-trn-key="TR_CLOUD_APPLY_DOMAIN_DESCRIPTION" style="${customer == null || customer.ownDomainYn ? 'display: none;' : ''}">
                                    <%--(등록한 도메인 전체를 확인합니다)--%>
                                </span>
                        ...
                        <tr class="ownDomainTrueArea" id="nameServerUseRowspan" rowspan="2">
                        ...
                        <tr class="ownDomainTrueArea nameServerUseTrueArea">
                            <td colspan="3">
                                <label class="dis_ib mw155">
                                    <input type="radio" name="recordFileEmptyYn" value="true" checked> <span class="trn" data-trn-key="TR_CLOUD_RECORD_FILE_IS_EMPTY"><%--레코드 정보 파일 없음--%></span>
                                </label>
                                <label class="dis_ib mw155">
                        ...
                        <tr class="ownDomainTrueArea nameServerUseTrueArea recordFileExistArea">
                            <td colspan="3">
                                <span class="dis-b mb10">
                                    ...
                                    <input type="button" class="btn btn-baseRound ownDomainTrueArea ml10 trn" data-trn-value="TR_CLOUD_RECORD_FORM_FILE" value="" onclick="location.href='/file/formfileDownload?gubun=dns_record'"><%--양식 다운로드--%>
                                </span>
                                ${dnsRecordFile.name}
                                <input type="file" name="dnsRecordFile" class="w300">
                            </td>
                        </tr>
            ...
            <section class="mt30">
                ...
                <div class="b-tableWrap mt20 border-b">
                    <table class="b-listTable b-listTable--border">
                        ...
                        <tr class="iServiceArea">
                            ...
                            <td>
                                <label class="dis_ib w80">
                                    <input type="radio" name="pop3UseYn" value="true" checked> <span class="trn" data-trn-key="TR_COMMON_USED"><%--사용함--%></span>
                                </label>
                                <label class="dis_ib w80">
                                    <input type="radio" name="pop3UseYn" value="false" ${!customer.pop3UseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="useSchedule" value="false" ${!customer.useSchedule ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                            ...
                            <td>
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="organizationYn" value="false" ${!customer.organizationYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED">사용 안함</span>
                                </label>
                            </td>
                        </tr>
                        <tr class="nServiceMailArea">
                            ...
                            <td class="border-b">
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="messageUseYn" value="false" ${!customer.messageUseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                            ...
                            <td>
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="noticeUseYn" value="false" ${!customer.noticeUseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="border-b">
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="groupwareUseYn" value="false" onchange="setAreaByGroupwareUseYn()" ${!customer.groupwareUseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                            ...
                            <td class="border-b">
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="financeUseYn" value="false" ${!customer.financeUseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                        </tr>
                        <c:if test="${customer.equipmentInstallYn}">
                        <tr>
                            ...
                            <td>
                                ...
                                <p class="fc-red mt5 perAddrUseYnDescription trn ${customer.perAddrUseYn ? 'dis_n' : ''}" data-trn-key="TR_CLOUD_GUARD_MAIL_BOX_USE_YN_DESCRIPTION1" data-key="1"><%--* 개인 주소록 + 공용주소록 사용--%></p>
                                <p class="fc-red mt5 perAddrUseYnDescription trn ${!customer.perAddrUseYn ? 'dis_n' : ''}" data-trn-key="TR_CLOUD_GUARD_MAIL_BOX_USE_YN_DESCRIPTION2" data-key="0"><%--* 기업 주소록 + 공용주소록 사용--%></p>
                            </td>
                            ...
                            <td>
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="guardMailBoxUseYn" value="0" onchange="setPerAddrUseYnDescription()" ${!customer.guardMailBoxUseYn ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                        </tr>
                        </c:if>
                        <tr>
                            ...
                            <td>
                                ...
                                <label class="dis_ib w80">
                                    <input type="radio" name="agreePass" value="0" ${!customer.agreePass ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                            <th class="trn" data-trn-key="TR_CLOUD_TELEGRAM_NOTIFICATION_USE_YN"><%--텔레그램 알림 기능 사용 여부--%></th>
                            <td>
                                <label class="dis_ib w80">
                                    <input type="radio" name="telegramNotification" value="1" checked> <span class="trn" data-trn-key="TR_COMMON_USED"><%--사용함--%></span>
                                </label>
                                <label class="dis_ib w80">
                                    <input type="radio" name="telegramNotification" value="0" ${!customer.telegramNotification ? 'checked' : ''}> <span class="trn" data-trn-key="TR_COMMON_NOT_USED"><%--사용 안함--%></span>
                                </label>
                            </td>
                        </tr>
                ...
                <div class="b-tableWrap mt20">
                    <table class="b-listTable b-listTable--border">
                        ...
                        <tr class="addApplyArea">
                            ...
                            <td>
                                <select class="w155" id="addStorage" onchange="setConsumerPrice()">
                                    ...
                                    <option value="999" class="trn" data-trn-key="TR_OTHER" ${storage ne null && !fn:contains(ectStorage, storage) ? 'selected' : ''}><%--기타--%></option>
                                </select>
                                <span class="addStorageOtherArea">
                                    <input type="text" name="addStorage" class="default-input w100 onlynumber autoComma" onchange="addApplyChange(this)" value="${customer.addStorage}" maxlength="6"> GB
                                </span>
                            </td>
                        ...
                        <tr class="iServiceArea addApplyArea">
                            ...
                            <td colspan="3">
                                <input type="text" name="addAccountCount" class="default-input w155 onlynumber autoComma" onchange="setConsumerPrice()" value="${customer.addAccountCount}" maxlength="6"> <span class="trn" data-trn-key="TR_COMMON_COUNT"><%--개--%></span>
                        ...
                        <tr class="iServiceArea addApplyArea">
                            ...
                            <td colspan="3">
                                <input type="text" name="groupMailCount" class="default-input w155 onlynumber autoComma" onchange="setConsumerPrice()" value="${customer.groupMailCount}" maxlength="6"> <span class="trn" data-trn-key="TR_COMMON_COUNT"><%--개--%></span> <span class="trn" data-trn-key="TR_CLOUD_GROUP_MAIL_COUNT_UNIT"><%--(신청 단위 5계정)--%></span>
                            </td>
                        </tr>
                        ...
                        <tr class="nServiceArea">
                            <th class="trn" data-trn-key="TR_CLOUD_ADD_EXCHANGE_SIZE"><%--메일 백업용량 추가--%></th><span class="trn" data-trn-key="TR_CLOUD_ADD_EXCHANGE_SIZE_UNIT"><%--(50GB 단위)--%></span>
                            <td>
                        ...
                        <table class="b-listTable">
                            ...
                            <c:if test="${customer == null}">
                                <tr>
                                    ...
                                    <td class="a-center">
                                        <input type="text" class="onlynumber autoComma costPerAccount" value="100" onchange="setMarginCalc(this)">%
                                    </td>
                                    <td class="a-center">
                                    ...
                                    <td class="a-center">
                                        <input type="text" class="onlynumber w50 marginRate" value="100" onchange="setMarginCalc(this)">%
                                    </td>
                                    <td class="a-center">
                    ...
                    <table class="b-listTable b-listTable--border">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td rowspan="3" id="customerPaymentYearlyArea" class="trn ${customer.paymentWay == 'M' ? '' : 'dis_n'}" data-trn-key="TR_NOT_APPLICABLE"><%--해당없음--%></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="red-txt">
                                    <span id="supplyCostPerAccountArea"><fmt:formatNumber value="${(customerPartnerCalc.supplyPrice - (customerPartnerCalc.additionalPrice - customerPartnerCalc.partnerAdditionalPrice)) / customer.applyAccountCount}" pattern="#,###"/></span> <span class="trn" data-trn-key="TR_COMMON_WON"><%--원--%></span>
                                </td>
                                <td>
                ...
                <div class="b-tableWrap mt20 over-x__n">
                    <table class="b-listTable b-listTable--border">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="oldmailSupplyPrice" class="onlynumber autoComma a_right w155" value="${customerPartnerCalc.supplyPrice}">
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="btn-area">
                <input type="button" class="btn-base btn-add btn-large mr5 trn" data-trn-value="TR_COMMON_${customer.idx > 0 ?  'MODIFIED' : 'REGISTRATION'}" value="" onclick="saveConfirm()"><%--수정 or 등록--%>
                <c:choose>
