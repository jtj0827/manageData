    ...
    <table class="b-listTable b-listTable--border">
        ...
        <tr>
            ...
            <td>
                ...
                <p style="color: #0b94d1;" class="trn" data-trn-key="TR_CLOUD_ADD_ONEDRIVE_SIZE_UNIT"><%--(단위 : 20GB)--%></p>
            </td>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: right;" class="point-bg">
        ...
        <td>
            <fmt:formatNumber value="${customer.addStorage > 0 ? customer.addStorage : 0}" pattern="#,###"/>GB
            <p style="color: #0b94d1;" class="trn" data-trn-key="TR_CLOUD_ADD_STORAGE_UNIT_20GB"><%--(단위 : 20GB)--%></p>
        </td>
        <td style="text-align: right;">
            <fmt:formatNumber value="${customerCalc.storageCalc > 0 ? customerCalc.storageCalc : 0}" pattern="#,###"/><span class="trn" data-trn-key="TR_COMMON_WON"><%--원--%></span>
        </td>
