    ...
    <div class="b-listSearchForm">
        <div class="b-listSearchForm__inner">
            <form id="partnerSearchForm">
                <input type="hidden" name="topIdx" value="${partner.idx}">
                <input type="hidden" name="pageNo" value="1">
                <div class="b-form-group">
                    <div class="b-form-group__item">
                        <label>검색 조건</label>
                        <div class="inline-group">
                            <select name="searchType" class="default-input w100 ml20">
                                <option value="">전체</option>
                                <option value="P">파트너사</option>
                                <option value="T">상위 파트너사</option>
                            </select>
                            <%-- LINE :: 검색어 input 엔터 서브밋 방지를 위한 input[type=hidden] 태그 --%>
                            <input hidden="hidden"/>
                            <input type="text" class="default-input w200" name="searchText" maxlength="100" onkeydown="if (window.event.keyCode == 13) getPartnerListAjax('S');" placeholder="파트너사 명">
                        </div>
                    </div>
                    ...
                    <div class="b-form-group__item">
                        ...
                        <div class="inline-group">
                            ...
                            <%--검색--%>
                            <input type="button" class="btn-base btn-search w100" value="검색" onclick="getPartnerListAjax('S')">
                        </div>
