...
<script type="text/babel" src="/resources/js/data/addrExcept.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-발송지 예외</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                <label class="dis-ib a-center w80">주소</label>
                                <input type="text" class="w120" id="comaeDomain" name="comaeDomain" value="${param.comaeDomain}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">메모</label>
                                <input type="text" class="w120" id="comaeEtc" name="comaeEtc" value="${param.comaeEtc}" onkeyup="searchSubmit();" maxlength="100">
                            </div>
                        </div>
                ...
                <div class="b-tableWrap">
                    <table class="b-listTable">
                        ...
                        <tr style="cursor: pointer;">
                            ...
                            <th><a onclick="sortList('1');">주소<span id="orderBy1_txt"></span></a></th>
                            <th><a onclick="sortList('2');">메모<span id="orderBy2_txt"></span></a></th>
                            <th><a onclick="sortList('3');">등록일자<span id="orderBy6_txt"></span></a></th>
                        </tr>
                        </thead>
                        <tbody id="tableBody">
                        <c:if test="${totalCount eq 0}">
                            <tr>
                                <td class="a-center" colspan="4">조회되는 데이터가 없습니다.</td>
                            </tr>
                        </c:if>
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.comaeIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.comaeDomain}</td>
                                    <td class="a-center">${data.comaeEtc}</td>
