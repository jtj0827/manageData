...
<script type="text/babel" src="/resources/js/data/allowIP.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-IP 허용</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                ...
                                <input type="text" class="w120" id="comsDomain" name="comsDomain" value="${param.comsDomain}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">IP</label>
                                <input type="text" class="w120" id="comsIpAddr" name="comsIpAddr" value="${param.comsIpAddr}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">내용</label>
                                <input type="text" class="w200 mr30" name="comsEtc" value="${param.comsEtc}" maxlength="150">
                            </div>
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    ...
                                    <td class="a-center">${data.comsDomain}</td>
                                    <td class="a-center">${data.comsIpAddr}</td>
                                    <td>${data.comsEtc}</td>
