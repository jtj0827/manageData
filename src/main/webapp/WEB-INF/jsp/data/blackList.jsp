...
<script type="text/babel" src="/resources/js/data/blackList.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">블랙리스트</h1>
        ...
        <div class="l-content">
            <div class="b-list">
                <div class="b-list-top">
                    ...
                    <input type="button" class="btn-baseRound trn" onclick="blackListPopup()" value="등록">
...
<%--                            <col width="20%"/>--%>
                        ...
                        <thead>
                        <tr>
                            <th><input type="checkbox" name="blackListCheckGubun" class="blackListCheckGubun" onchange="allCheckedBox()"></th>
                            <th>검사범위/구분/조건</th>
                            <th>내용</th>
                            <th>설명</th>
                            <th>점수</th>
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${blackList}" var="data" varStatus="status">
                                <tr class="pointer">
                                    <td class="a-center">
                                        <input type="checkbox" name="blackListCheckGubun" class="blackListCheckGubun" value="${data.idx}">
                                    </td>
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')">
                                        <c:choose>
                                    ...
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')">${data.contents}</td>
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')">${data.explanation}</td>
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')">${data.spamScore}</td>
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')">${data.regId}</td>
                                    <td class="a-center" onclick="blackListPopup('${data.idx}')"><fmt:formatDate value="${data.regDate}" pattern="yyyy-MM-dd HH:mm"/></td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        </tbody>
