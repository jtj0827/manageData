...
<script type="text/babel" src="/resources/js/data/blockDomain.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-Domain 차단</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                ...
                                <input type="text" class="w120" id="combdDomain" name="combdDomain" value="${param.combdDomain}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">IP</label>
                                <input type="text" class="w120" id="combdIp" name="combdIp" value="${param.combdIp}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">내용</label>
                                <input type="text" class="w200 mr30" name="combdEtc" value="${param.combdEtc}" maxlength="150">
                            </div>
                ...
                <div class="b-tableWrap">
                    <table class="b-listTable">
                        ...
                        <tr style="cursor: pointer;">
                            ...
                            <th><a onclick="sortList('2');">아이피<span id="orderBy2_txt"></span></a></th>
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.combdIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.combdDomain}</td>
                                    <td class="a-center">${data.combdIp}</td>
                                    <td>${data.combdEtc}</td>
