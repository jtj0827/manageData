...
<script type="text/babel" src="/resources/js/data/docExt.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-문서위변조</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                ...
                                <input type="text" class="w120" id="docextName" name="docextName" value="${param.docextName}" onkeyup="searchSubmit();" maxlength="50">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">MINE</label>
                                <input type="text" class="w120" id="comdEtc" name="comdEtc" value="${param.comdEtc}" onkeyup="searchSubmit();" maxlength="350">
                            </div>
                    ...
                    <table class="b-listTable">
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.comdIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.docextName}</td>
                                    <td>${data.comdEtc}</td>
