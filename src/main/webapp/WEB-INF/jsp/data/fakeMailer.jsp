...
<script type="text/babel" src="/resources/js/data/fakeMailer.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-FakeMailer</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                ...
                                <input type="text" class="w120" id="comfmDomain" name="comfmDomain" value="${param.comfmDomain}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">메모</label>
                                <input type="text" class="w120" id="comfmEtc" name="comfmEtc" value="${param.comfmEtc}" onkeyup="searchSubmit();" maxlength="100">
                            </div>
                    ...
                    <table class="b-listTable">
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.comfmIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.comfmDomain}</td>
                                    <td class="a-center">${data.comfmEtc}</td>
