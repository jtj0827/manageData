...
<script type="text/babel" src="/resources/js/data/portalMail.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-기업 메일</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                ...
                                <input type="text" class="w120" id="commdDomain" name="commdDomain" value="${param.commdDomain}" onkeyup="searchSubmit();" maxlength="100">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">기업명</label>
                                <input type="text" class="w120" id="commdEtc" name="commdEtc" value="${param.commdEtc}" onkeyup="searchSubmit();" maxlength="100">
                            </div>
                ...
                <div class="b-tableWrap">
                    <table class="b-listTable">
                        ...
                        <tr style="cursor: pointer;">
                            ...
                            <th><a onclick="sortList('1');">도메인<span id="orderBy1_txt"></span></a></th>
                            <th><a onclick="sortList('2');">기업명<span id="orderBy2_txt"></span></a></th>
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.commdIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.commdDomain}</td>
                                    <td>${data.commdEtc}</td>
