...
<script type="text/babel" src="/resources/js/data/similarString.js"></script>

<section class="l-content-area">

    <!--메인타이틀 영역 <h1 class="main-title">-->
    <h1 class="main-title">중앙 데이터 관리-유사문자</h1>
                    ...
                    <div class="b-form-group">
                        <div class="b-form-group__item">
                            <div class="inline-group">
                                <label class="dis-ib a-center w80">대상문자</label>
                                <input type="text" class="w120" id="comssWord" name="comssWord" value="${param.comssWord}" onkeyup="searchSubmit();" maxlength="2">
                            </div>

                            <div class="inline-group">
                                <label class="dis-ib a-center w80">변경문자</label>
                                <input type="text" class="w120" id="comssWord2" name="comssWord2" value="${param.comssWord2}" onkeyup="searchSubmit();" maxlength="1">
                            </div>
                ...
                <div class="b-tableWrap">
                    <table class="b-listTable">
                        ...
                        <tr style="cursor: pointer;">
                            ...
                            <th><a onclick="sortList('1');">대상문자<span id="orderBy1_txt"></span></a></th>
                            <th><a onclick="sortList('2');">변경문자<span id="orderBy2_txt"></span></a></th>
                        ...
                        <c:if test="${totalCount ne 0}">
                            <c:forEach items="${list}" var="data" varStatus="status">
                                <tr>
                                    <td class="a-center"><input type="checkbox" class="checkIdx" value="${data.comssIdx}" onclick="singleCheck();"></td>
                                    <td class="a-center">${data.comssWord}</td>
                                    <td class="a-center">${data.comssWord2}</td>
