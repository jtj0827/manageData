...
<head>
    ...
    <!--국지화 작업-->
    <script src="/resources/js/translate.js-0.9.1/jquery.translate.js"></script>
    <script src="/resources/js/lang/languagePack.js"></script>
    <script src="/resources/js/lang/commonlanguagePack.js"></script>
    <script src="/resources/js/lang/nationlanguagePack.js"></script>
