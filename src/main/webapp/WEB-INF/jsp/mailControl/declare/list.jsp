            ...
            <div class="b-list">
                ...
                <div class="b-tableWrap">
                    ...
                    <table class="b-listTable plus">
                        ...
                        <c:forEach var="declareMail" items="${declareMailList}" varStatus="status">
                            <tr class="pointer" onclick="moveView(${declareMail.idx})">
                                <td class="a_center">${(totalCount-status.index) - ((paging.pageNo-1) * paging.pageSize)}</td>
                                <td class="a_center">${declareMail.declareNumber}</td>
                                <td class="a_center">
