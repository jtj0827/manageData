...
<section class="l-content-area">
    ...
    <h1 class="main-title">MIMS 버전 관리</h1>
                ...
                <div class="b-tableWrap">
                    ...
                    <table class="b-listTable plus">
                        ...
                        <colgroup>
                            ...
                            <col width="10%"><%--서버 명칭--%>
                            <col width="10%"><%--시리얼 번호--%>
                            <col width="10%"><%--SCMHAMAG--%>
                            <col width="10%"><%--SCMHASVER MAIN--%>
                            <col width="10%"><%--SCMHASVR PARSER--%>
                            <col width="10%"><%--IGUARD FIREWALL--%>
                            <col width="10%"><%--IGUARD DAEMONE--%>
                        </colgroup>
                        <thead>
                        <tr>
                            <th>번호</th>
                        ...
                        <c:forEach var="versionInfo" items="${infoList}" varStatus="status">
                            <tr class="pointer" onclick="moveServerView(${versionInfo.serverIdx})">
                                ...
                                <td class="a_center">
                                    <%--SCMHAMAG--%>
                                    <span class="${versionInfo.scmhamag != latestInfo.scmhamag ? 'red-txt' : ''}">${versionInfo.scmhamag}</span>
                                </td>
                                <td class="a_center">
                                    <%--SCMHASVER MAIN--%>
                                    <span class="${versionInfo.scmhamag != latestInfo.scmhamag ? 'red-txt' : ''}">${versionInfo.scmhamag}</span>
                                ...
                                <td class="a_center">
                                    <%--SCMHASVR PARSER--%>
                                    <span class="${versionInfo.scmhasvrParser != latestInfo.scmhasvrParser ? 'red-txt' : ''}">${versionInfo.scmhasvrParser}</span>
                                </td>
                                <td class="a_center">
                                    <%--IGUARD FIREWALL--%>
                                    <span class="${versionInfo.iguardFirewall != latestInfo.iguardFirewall ? 'red-txt' : ''}">${versionInfo.iguardFirewall}</span>
                                </td>
                                <td class="a_center">
                                    <%--IGUARD DAEMONE--%>
                                    <span class="${versionInfo.iguardDaemon != latestInfo.iguardDaemon ? 'red-txt' : ''}">${versionInfo.iguardDaemon}</span>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
